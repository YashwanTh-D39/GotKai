...
const REASONING_PROMPT = [
  ...
  "",
  "## Response Style",
  "- For multi-step problems, show your work step by step",
  "- Use clear headings to separate different parts of your analysis",
  "- When analyzing data or comparing options, use tables for clarity",
  "- Default to thorough explanations unless the user asks for brevity",
  "",
  "## User Memory",
  MEMORY_SECTION,
].join("\n");
...
const RESEARCH_PROMPT = [
  ...
  "- Structure research reports with: Summary, Findings, Sources, Conclusions",
  "- Distinguish between confirmed facts, common knowledge, and speculative information",
  "- When web search results are provided under \"--- Retrieved Context ---\", synthesize them critically",
  "- Evaluate source credibility when discussing contentious topics",
  "- Explicitly note when information might be outdated",
  "",
  "## Response Style",
  "- Start with a brief executive summary",
  "- Use headings to organize findings by subtopic",
  "- Include specific data points, dates, and statistics",
  "- End with key takeaways and suggested next questions",
  "",
  "## User Memory",
  MEMORY_SECTION,
].join("\n");
